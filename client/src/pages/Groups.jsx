...
const ConfrimDeleteDialog = React.lazy(() =>
    import('../components/dialogs/ConfrimDeleteDialog.jsx'),
);
        ...
        <Box sx={{display: 'flex', height: '100vh', width: '100%'}}>
            ...
            >
                ...
                {groupName && (
                    <>
                        <GroupName/>
                        <Typography margin={'2rem'} alignItems={'flex-start'} variant={'body1'}></Typography>
                        <Stack
                            maxWidth="45rem"
                            width="100%"
